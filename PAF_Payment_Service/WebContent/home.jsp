            ...
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="#" class="btn btn-primary">Manage Hospitals</a>
                </div>
              </div>
            </div>
            <!-- doctors  -->
            ...
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <!-- <p class="card-text">With supporting text below as a natural lead-in to additional content.</p> -->
                  <a href="#" class="btn btn-primary">Manage Appointements</a>
                </div>
              </div>
            </div>
        </div>
            ...
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <!-- <p class="card-text">With supporting text below as a natural lead-in to additional content.</p> -->
                  <a href="adminPayment.jsp"><input type="button" value="Manage Payment" class="btn btn-primary"></a>
                </div>
              </div>
            </div>
            <!-- about  -->
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <!-- <p class="card-text">With supporting text below as a natural lead-in to additional content.</p> -->
                  <a href="#" class="btn btn-primary">Manage Details</a>
                </div>
              </div>
            </div>
        </div>
